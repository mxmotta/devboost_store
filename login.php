        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            <form action="login.php" method="POST">
                <div>
                    ...
                    <div class="mt-2">
                        <input id="email" name="login" type="email" autocomplete="email" required class="block w-full rounded-md border-0 py-1.5 px-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                    </div>
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <a href="register.php" class="flex w-full justify-center rounded-md bg-indigo-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Registrar</a>
                </div>
            </form>
        </div>
    </div>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['login']) && isset($_POST['password'])) {
    ...
    echo "<script>window.location.href='/login.php?message=Login inválido!'</script>";
}
